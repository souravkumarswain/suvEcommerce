...
const Checkout = () => {
  ...
  const handleChange = (e) => {
    ...
    setDeliveryDetails(prvs => ({...prvs,[name]:value}))
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            border border-gray-800">
              ...
              space-x-3 border-b border-gray-700 pb-4">
                <FiMapPin className="w-7 h-7 text-orange-500"/>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                {Object.keys(deliveryDetails).map(key => (
                  <div key = {key}>
                      <label htmlFor={key} 
                      className="block text-sm fomt-semibold text-gray-300 capitalize mb-1">
                ...
                <div className="pt-6 ">
                   ...
                   type = "submit"
              // to={'/checkout'}
                className='w-full py-4 bg-orange-600 text-white
